...
# IP: bd/design_1/ip/design_1_StreamingDataflowPar_0_0/design_1_StreamingDataflowPar_0_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_StreamingDataflowPar_0_0 || ORIG_REF_NAME==design_1_StreamingDataflowPar_0_0} -quiet] -quiet

# IP: bd/design_1/ip/design_1_custom_fifo_0_1/design_1_custom_fifo_0_1.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_custom_fifo_0_1 || ORIG_REF_NAME==design_1_custom_fifo_0_1} -quiet] -quiet
...
# IP: bd/design_1/ip/design_1_axi_mem_intercon_imp_auto_us_df_0/design_1_axi_mem_intercon_imp_auto_us_df_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_axi_mem_intercon_imp_auto_us_df_0 || ORIG_REF_NAME==design_1_axi_mem_intercon_imp_auto_us_df_0} -quiet] -quiet

# IP: bd/design_1/ip/design_1_axi_mem_intercon_imp_auto_us_df_1/design_1_axi_mem_intercon_imp_auto_us_df_1.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_axi_mem_intercon_imp_auto_us_df_1 || ORIG_REF_NAME==design_1_axi_mem_intercon_imp_auto_us_df_1} -quiet] -quiet

# IP: bd/design_1/ip/design_1_axi_mem_intercon_imp_m00_data_fifo_0/design_1_axi_mem_intercon_imp_m00_data_fifo_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_axi_mem_intercon_imp_m00_data_fifo_0 || ORIG_REF_NAME==design_1_axi_mem_intercon_imp_m00_data_fifo_0} -quiet] -quiet
...
# IP: bd/design_1/ip/design_1_axi_periph_imp_s00_data_fifo_0/design_1_axi_periph_imp_s00_data_fifo_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_axi_periph_imp_s00_data_fifo_0 || ORIG_REF_NAME==design_1_axi_periph_imp_s00_data_fifo_0} -quiet] -quiet

# IP: bd/design_1/ip/design_1_axi_periph_imp_auto_pc_0/design_1_axi_periph_imp_auto_pc_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==design_1_axi_periph_imp_auto_pc_0 || ORIG_REF_NAME==design_1_axi_periph_imp_auto_pc_0} -quiet] -quiet

# XDC: /home/emre/projectZed/projectZed.gen/sources_1/bd/design_1/design_1_ooc.xdc
