...
(* CORE_GENERATION_INFO = "StreamingDataflowPartition_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=StreamingDataflowPartition_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=3,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=4,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "StreamingDataflowPartition_1.hwdef" *) 
...
module StreamingDataflowPartition_1_MVAU_hls_0_imp_BWPU8W
  ...
  wire [7:0]StreamingDataflowPartition_1_MVAU_hls_0_wstrm_m_axis_0_TDATA;
...
module StreamingDataflowPartition_1_MVAU_hls_1_imp_KIE98K
  ...
  wire [7:0]StreamingDataflowPartition_1_MVAU_hls_1_wstrm_m_axis_0_TDATA;
...
module StreamingDataflowPartition_1_MVAU_hls_2_imp_1TQ8MQW
  ...
  wire [7:0]StreamingDataflowPartition_1_MVAU_hls_2_wstrm_m_axis_0_TDATA;
  ...
  StreamingDataflowPartition_1_StreamingDataflowPartition_1_MVAU_hls_2_0 StreamingDataflowPartition_1_MVAU_hls_2
       (.ap_clk(ap_clk),
        .ap_rst_n(ap_rst_n),
        .in0_V_TDATA(in0_V_tdata),
        .in0_V_TREADY(in0_V_tready),
