...
entity StreamingDataflowPartition_2_IODMA_hls_0_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity StreamingDataflowPartition_2_IODMA_hls_0_regslice_both;

architecture behave of StreamingDataflowPartition_2_IODMA_hls_0_regslice_both is
