; ModuleID = '/tmp/finn_dev_emre/code_gen_ipgen_StreamingDataflowPartition_1_MVAU_hls_1_2hlhfuts/project_StreamingDataflowPartition_1_MVAU_hls_1/sol1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_StreamingDataflowPartition_1_MVAU_hls_1_ir(%"class.hls::stream<ap_uint<4>, 0>"* noalias nocapture nonnull dereferenceable(1) %in0_V, %"class.hls::stream<ap_uint<4>, 0>"* noalias nocapture nonnull dereferenceable(1) %weights_V, %"class.hls::stream<ap_uint<4>, 0>"* noalias nocapture nonnull dereferenceable(1) %out_V) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_StreamingDataflowPartition_1_MVAU_hls_1_hw(i4* %in0_V_copy, i4* %weights_V_copy, i4* %out_V_copy)
...
declare void @apatb_StreamingDataflowPartition_1_MVAU_hls_1_hw(i4*, i4*, i4*)
...
declare void @StreamingDataflowPartition_1_MVAU_hls_1_hw_stub(%"class.hls::stream<ap_uint<4>, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_uint<4>, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_uint<4>, 0>"* noalias nocapture nonnull)

define void @StreamingDataflowPartition_1_MVAU_hls_1_hw_stub_wrapper(i4*, i4*, i4*) #6 {
entry:
  ...
  call void @StreamingDataflowPartition_1_MVAU_hls_1_hw_stub(%"class.hls::stream<ap_uint<4>, 0>"* %4, %"class.hls::stream<ap_uint<4>, 0>"* %6, %"class.hls::stream<ap_uint<4>, 0>"* %8)
