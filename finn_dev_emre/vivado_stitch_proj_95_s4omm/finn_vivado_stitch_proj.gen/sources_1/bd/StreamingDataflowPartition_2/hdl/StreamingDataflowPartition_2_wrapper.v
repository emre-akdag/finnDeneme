...
//Date        : Wed Mar 26 22:52:27 2025
//Host        : finn_dev_emre running 64-bit Ubuntu 22.04.1 LTS
//Command     : generate_target StreamingDataflowPartition_2_wrapper.bd
//Design      : StreamingDataflowPartition_2_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module StreamingDataflowPartition_2_wrapper
   (ap_clk,
    ap_rst_n,
    m_axi_gmem0_araddr,
    m_axi_gmem0_arburst,
  ...
  StreamingDataflowPartition_2 StreamingDataflowPartition_2_i
       (.ap_clk(ap_clk),
        .ap_rst_n(ap_rst_n),
