create_project finn_vivado_stitch_proj /tmp/finn_dev_emre/vivado_stitch_proj_95_s4omm -part xc7z020clg400-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_emre/code_gen_ipgen_StreamingDataflowPartition_2_IODMA_hls_0_8mzee8u5/project_StreamingDataflowPartition_2_IODMA_hls_0/sol1/impl/ip] [current_project]
update_ip_catalog
create_bd_design "StreamingDataflowPartition_2"
create_bd_cell -type ip -vlnv xilinx.com:hls:StreamingDataflowPartition_2_IODMA_hls_0:1.0 StreamingDataflowPartition_2_IODMA_hls_0
make_bd_pins_external [get_bd_pins StreamingDataflowPartition_2_IODMA_hls_0/ap_clk]
set_property name ap_clk [get_bd_ports ap_clk_0]
make_bd_pins_external [get_bd_pins StreamingDataflowPartition_2_IODMA_hls_0/ap_rst_n]
set_property name ap_rst_n [get_bd_ports ap_rst_n_0]
make_bd_intf_pins_external [get_bd_intf_pins StreamingDataflowPartition_2_IODMA_hls_0/s_axi_control]
make_bd_intf_pins_external [get_bd_intf_pins StreamingDataflowPartition_2_IODMA_hls_0/m_axi_gmem]
set_property name m_axi_gmem0 [get_bd_intf_ports m_axi_gmem_0]
assign_bd_address
set_property offset 0 [get_bd_addr_segs {StreamingDataflowPartition_2_IODMA_hls_0/Data_m_axi_gmem/SEG_m_axi_gmem0_Reg}]
set_property range 4G [get_bd_addr_segs {StreamingDataflowPartition_2_IODMA_hls_0/Data_m_axi_gmem/SEG_m_axi_gmem0_Reg}]
make_bd_intf_pins_external [get_bd_intf_pins StreamingDataflowPartition_2_IODMA_hls_0/in0_V]
set_property name s_axis_0 [get_bd_intf_ports in0_V_0]
set_property CONFIG.FREQ_HZ 50000000 [get_bd_ports /ap_clk]
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_emre/vivado_stitch_proj_95_s4omm/finn_vivado_stitch_proj.srcs/sources_1/bd/StreamingDataflowPartition_2/StreamingDataflowPartition_2.bd] -top
add_files -norecurse /tmp/finn_dev_emre/vivado_stitch_proj_95_s4omm/finn_vivado_stitch_proj.srcs/sources_1/bd/StreamingDataflowPartition_2/hdl/StreamingDataflowPartition_2_wrapper.v
set_property top StreamingDataflowPartition_2_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_emre/vivado_stitch_proj_95_s4omm/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module StreamingDataflowPartition_2 -import_files
...
set fp [open /tmp/finn_dev_emre/vivado_stitch_proj_95_s4omm/all_verilog_srcs.txt w]
