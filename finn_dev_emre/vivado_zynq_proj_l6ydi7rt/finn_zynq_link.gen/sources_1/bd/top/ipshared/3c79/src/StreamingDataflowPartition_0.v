...
(* CORE_GENERATION_INFO = "StreamingDataflowPartition_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=StreamingDataflowPartition_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "StreamingDataflowPartition_0.hwdef" *) 
module StreamingDataflowPartition_0
  ...
  StreamingDataflowPartition_0_StreamingDataflowPartition_0_IODMA_hls_0_0 StreamingDataflowPartition_0_IODMA_hls_0
       (.ap_clk(ap_clk),
        .ap_rst_n(ap_rst_n),
