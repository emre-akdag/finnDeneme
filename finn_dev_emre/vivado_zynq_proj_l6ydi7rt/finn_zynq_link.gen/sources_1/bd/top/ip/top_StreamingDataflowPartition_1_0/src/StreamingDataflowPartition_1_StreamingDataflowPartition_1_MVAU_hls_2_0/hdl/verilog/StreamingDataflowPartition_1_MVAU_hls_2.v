...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_MVAU_hls_2_StreamingDataflowPartition_1_MVAU_hls_2,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=13.931000,HLS_SYN_LAT=649,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=624,HLS_SYN_LUT=1607,HLS_VERSION=2024_2}" *)
...
StreamingDataflowPartition_1_MVAU_hls_2_Matrix_Vector_Activate_Stream_Batch grp_Matrix_Vector_Activate_Stream_Batch_fu_60(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
StreamingDataflowPartition_1_MVAU_hls_2_regslice_both #(
    .DataWidth( 8 ))
...
endmodule //StreamingDataflowPartition_1_MVAU_hls_2
