...
HD_PWD='/tmp/finn_dev_emre/vivado_zynq_proj_l6ydi7rt/finn_zynq_link.runs/top_idma0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_idma0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_idma0_0.tcl
