set moduleName Mem2Stream_Batch_64u_784u_Pipeline_VITIS_LOOP_140_11
set isTopModule 0
...
set cdfgNum 8
set C_modelName {Mem2Stream_Batch<64u, 784u>_Pipeline_VITIS_LOOP_140_11}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 64 regular {axi_master 0}  }
	{ sext_ln140 int 61 regular  }
	{ dma2dwc int 64 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in0_V","offset": { "type": "dynamic","port_name": "in0_V","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln140", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "dma2dwc", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ dma2dwc_din sc_out sc_lv 64 signal 2 } 
	{ dma2dwc_full_n sc_in sc_logic 1 signal 2 } 
	{ dma2dwc_write sc_out sc_logic 1 signal 2 } 
	{ dma2dwc_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ dma2dwc_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ sext_ln140 sc_in sc_lv 61 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dma2dwc_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "dma2dwc", "role": "din" }} , 
 	{ "name": "dma2dwc_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dma2dwc", "role": "full_n" }} , 
 	{ "name": "dma2dwc_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dma2dwc", "role": "write" }} , 
 	...
 	{ "name": "sext_ln140", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln140", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln140 { ap_none {  { sext_ln140 in_data 0 61 } } }
	dma2dwc { ap_fifo {  { dma2dwc_din fifo_data_in 1 64 }  { dma2dwc_full_n fifo_status 0 1 }  { dma2dwc_write fifo_port_we 1 1 }  { dma2dwc_num_data_valid fifo_status_num_data_valid 0 3 }  { dma2dwc_fifo_cap fifo_update 0 3 } } }
}
