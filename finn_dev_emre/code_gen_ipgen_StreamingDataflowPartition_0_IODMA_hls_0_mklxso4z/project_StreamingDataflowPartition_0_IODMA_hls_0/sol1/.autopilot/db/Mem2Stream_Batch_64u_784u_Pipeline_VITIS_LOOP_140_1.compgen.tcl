...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dma2dwc \
    op interface \
    ports { dma2dwc_din { O 64 vector } dma2dwc_full_n { I 1 bit } dma2dwc_write { O 1 bit } dma2dwc_num_data_valid { I 3 vector } dma2dwc_fifo_cap { I 3 vector } } \
} "
}
