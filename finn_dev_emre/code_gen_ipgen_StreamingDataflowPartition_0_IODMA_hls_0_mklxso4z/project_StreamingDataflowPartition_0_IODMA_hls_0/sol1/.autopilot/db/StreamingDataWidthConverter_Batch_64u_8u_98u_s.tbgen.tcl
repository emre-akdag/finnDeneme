set moduleName StreamingDataWidthConverter_Batch_64u_8u_98u_s
set isTopModule 0
...
set cdfgNum 8
set C_modelName {StreamingDataWidthConverter_Batch<64u, 8u, 98u>}
...
set portList { 
	...
	{ dma2dwc_dout sc_in sc_lv 64 signal 0 } 
	{ dma2dwc_empty_n sc_in sc_logic 1 signal 0 } 
	{ dma2dwc_read sc_out sc_logic 1 signal 0 } 
	{ dma2dwc_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ dma2dwc_fifo_cap sc_in sc_lv 3 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "dma2dwc", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_StreamingDataWidthConverter_Batch_64u_8u_98u_Pipeline_VITIS_LOOP_526_1_fu_50", "Port" : "dma2dwc", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "out_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_StreamingDataWidthConverter_Batch_64u_8u_98u_Pipeline_VITIS_LOOP_526_1_fu_50", "Port" : "out_V", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_StreamingDataWidthConverter_Batch_64u_8u_98u_Pipeline_VITIS_LOOP_526_1_fu_50", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_StreamingDataWidthConverter_Batch_64u_8u_98u_Pipeline_VITIS_LOOP_526_1_fu_50.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	numReps { ap_fifo {  { numReps_dout fifo_data_in 0 32 }  { numReps_empty_n fifo_status 0 1 }  { numReps_read fifo_port_we 1 1 }  { numReps_num_data_valid fifo_status_num_data_valid 0 3 }  { numReps_fifo_cap fifo_update 0 3 } } }
}
