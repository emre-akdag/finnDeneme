...
entity StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S is 
    generic (
...
architecture rtl of StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S_ShiftReg : StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S_ShiftReg
    generic map (
...
entity StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S_ShiftReg;

architecture rtl of StreamingDataflowPartition_0_IODMA_hls_0_fifo_w64_d2_S_ShiftReg is
