...
entity StreamingDataflowPartition_1_MVAU_hls_2_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity StreamingDataflowPartition_1_MVAU_hls_2_regslice_both;

architecture behave of StreamingDataflowPartition_1_MVAU_hls_2_regslice_both is
