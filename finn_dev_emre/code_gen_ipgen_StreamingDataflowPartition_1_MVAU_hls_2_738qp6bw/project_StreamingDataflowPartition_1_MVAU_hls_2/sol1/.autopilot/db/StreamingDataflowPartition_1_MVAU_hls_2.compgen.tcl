...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { weights_V_TDATA { I 8 vector } weights_V_TVALID { I 1 bit } weights_V_TREADY { O 1 bit } } \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler StreamingDataflowPartition_1_MVAU_hls_2_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
